...
def map_initial(map_label):
    z_points, x_points, y_points = 171, 120, 170
    map_initial = np.zeros((171, 120, 170))
    index = 0
...
for i in range(dataNum):
    fusion_results = {}
    for SNR in SNRlevel:
        data_path = "D:\\3D代码文件\\show_data\\wusi3\\wusi3_4Fu_pad.mat"
        load_data(data_path)
        ...
        data_PA1= scipy.io.loadmat(
            "D:\\3D代码文件\\show_data\\wusi3\\wusi3_f3_cut_pad.mat")
        data_PA2= scipy.io.loadmat(
            "D:\\3D代码文件\\show_data\\wusi3\\wusi3_f4_cut_pad.mat")
        focus_A = data_PA1['wusi3_f3_cut_pad']
        focus_B = data_PA2['wusi3_f4_cut_pad']
        fusion = volumetric_information_fusion(focus_A, focus_B, sigma, radius, map_initial1)
        fusion_results['wusi3_f3_4_pad'] = fusion
    scipy.io.savemat('D:\\3D代码文件\\model_output\\fusion\\wusi1\\wusi3_f3_4_pad.mat', fusion_results)
