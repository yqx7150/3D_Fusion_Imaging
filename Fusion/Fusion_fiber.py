...
for i in range(dataNum):
    fusion_results = {}
    for SNR in SNRlevel:
        data_path = "D:\\3D代码文件\\fiber\\xianwei4\\fiber40_70_Fu.mat"
        load_data(data_path)
        ...
        data_PA1= scipy.io.loadmat(
            "D:\\3D代码文件\\fiber\\xianwei4\\dataxianwei_PA_z40_SNR0_0_1_cut")
        data_PA2= scipy.io.loadmat(
            "D:\\3D代码文件\\fiber\\xianwei4\\dataxianwei_PA_z70_SNR0_0_1_cut")
        focus_A = data_PA1['dataxianwei_PA_z40_SNR0_0_1_cut']
        focus_B = data_PA2['dataxianwei_PA_z70_SNR0_0_1_cut']
        fusion = volumetric_information_fusion(focus_A, focus_B, sigma, radius, map_initial1)
        fusion_results['fibe_40_70'] = fusion
    scipy.io.savemat('D:\\3D代码文件\\model_output\\fusion\\fiber\\fiber40_70fu.mat', fusion_results)
